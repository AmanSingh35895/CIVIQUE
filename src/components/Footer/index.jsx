                ...
                <div className="flex w-[94%] items-start justify-between gap-5 md:w-full md:flex-col">
                    <div className="flex w-[24%] flex-col items-start self-center md:w-full">
                        <div className="flex rounded-[10px] bg-white-a700 p-2">
                            <Img src="images/img_logo_civique.png" alt="Logocivique" className="h-[48px] w- [48px] object-cover" />
                        </div>
                        ...
                        <Heading size="headingxs" as="h6" className="mt-[92px] !text-[16px] !font-bold">
                            Copyright claim
                        </Heading>
                    </div>
                    <div className="mt-3 flex w- [64%] items-start justify-between gap-5 md:w-full md:flex-col">
                        ...
                        <ul className="flex w-[40%] flex-col items-start self-center md:w-full">
                            <li>
                            ...
                            <li>
                                <a href="COVID-19" target="_blank" rel="noreferrer" className="mt-[18px]">
                                    <Text as="p">COVID-19</Text>
                                </a>
                            </li>
                            <li>
                                <a href="Health" target="_blank" rel="noreferrer" className="mt-4">
                        ...
                        <ul className="flex flex-col items-start">
                            ...
                            <li>
                                <a href="Events" target="_blank" rel="noreferrer" className="mt-[18px]">
                                    <Text as="p">Events</Text>
                                </a>
                            </li>
                            <li>
                                <a href="Departments" target="_blank" rel="noreferrer" className="mt-[18px]">
