...
export default function LoginPageColouredPage() {
    return (
        <>
            ...
            <div className="flex w-full items-start justify-center gap-2.5 bg-white-a700 px-14 py-16 md:flex-col md:p-5">
                <div className="flex">
                    <Img
                ...
                <div className="mb-[226px] flex flex-1 items-center px-2.5 md:flex-col md:self-stretch">
                    <Img
                    ...
                    <div className="flex w-[38%] flex-col items-start gap-[66px] px-[34px] md:w-full sm:gap-[33px] sm:px-5">
                        ...
                        >
                            <TabList className="flex flex-wrap items-center gap-[34px]">
                                <Tab className="px-9 py-2.5 font-inter text-[16px] font-normal text-black-900_d8 sm:px-5">E-mail</Tab>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <div className="flex flex-col items-start gap-1.5 self-stretch">
                                                ...
                                                <Input
                                                    ...
                                                    type="email"
                                                    name="email"
                                                    placeholder={`siyam22249@gmail.com`}
                                                    className="w-[82%]"
                                                />
                                            </div>
                                            <div className="mt-[30px] self-stretch">
                                                <div className="flex flex-col items-start">
                                                    ...
                                                    <Input
                                                        ...
                                                        className="w- [82%] !text-gray-500" />
                                                </div>
                                            </div>
                                            <a href="#" className="mr-[66px] mt-3 self-end md:mr-0">
                                                <Heading size="headingxs" as="h4" className="!font-inter !font-bold !text-black-900">
                                                    Forgot password?
                                                </Heading>
                                            </a>
                                            <Button
                            ...
                            <div className="mx-[46px] flex flex-col items-start md:mx-0">
                                ...
                                <div className="ml-[76px] mt-5 flex items-center gap-[37px] md:ml-0">
                                    <div className="flex h-[28px] flex-col items-center bg-[url(/public/images/img_group_36.svg)] bg-cover bg-no-repeat px-2 md:h-auto">
                                        <Img src="images/img_facebook.svg" alt="Facebook" className="mt-1 h-[22px]" />
                                    </div>
                                    <Img src="images/img_devicon_google.svg" alt="Devicongoogle" className="h-[30px] w- [30px]" />
                                </div>
